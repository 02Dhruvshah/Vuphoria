...
{
    public string orderOptionsURL = "http://172.21.0.90/SQLData.php?Command=ordersOptions";
    public string dataTestURL = "http://msi/MachinesTestData/TestData1.php";
 ...
 public void Start()
    ...
    public void RequestOrderOptions()
    {
        if (listOfOrderOptionsPanel.transform.childCount < 1)
        {
            ...
            {
                StartCoroutine(GetRequest(orderOptionsURL));
    ...
    public void UpdateOrderData()
    {
        ...
        for (int i = 0; i < orderOptionObjectArray.Length; i++)
        {
            Debug.Log("PNo:" + orderOptionObjectArray[i].PNo + ", Description:" + orderOptionObjectArray[i].Description +", picture:" + orderOptionObjectArray[i].Picture);
            ...
            //Description
            OrderButtonScript.DescriptionText.text = orderOptionObjectArray[i].Description;
