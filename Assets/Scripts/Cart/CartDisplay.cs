...
public class CartDisplay : MonoBehaviour
{
    ...
    public TextMeshProUGUI CarrierID;
    public TextMeshProUGUI CarrierTypeID;

    public TextMeshProUGUI ONo;
    public TextMeshProUGUI OPos;
    //public TextMeshProUGUI CurentOrdersText;
    public TextMeshProUGUI PNo;  
     public TextMeshProUGUI PNoGroup; 

    public Cart cart;

    private void Start()
    {
        cart = GameObject.FindObjectOfType<Cart>();
    }
